...
def test_all_bindings_have_docstrings():
    ...
    targets = [
        ...
        noobase.convolve.gaussian1d,
        noobase.convolve.conv1d,
        noobase.convolve.conv_axis,
        noobase.convolve.conv2d,
        noobase.convolve.conv2d_renorm,
        noobase.convolve.conv_axis_renorm,
        ...
        noobase.spectroscopy.synthetic_photometry.SyntheticOperator.__init__,
        noobase.spectroscopy.synthetic_photometry.SyntheticOperator.apply,
        noobase.image.reproject_exact,
        noobase.image.ReprojectResult,
    ...
    property_targets = [
        ...
        (noobase.spectroscopy.synthetic_photometry.SyntheticOperator, "coverage"),
        (noobase.spectroscopy.synthetic_photometry.SyntheticOperator, "dtype"),
        (noobase.image.ReprojectResult, "image"),
        (noobase.image.ReprojectResult, "footprint"),
        (noobase.image.ReprojectResult, "weight"),
        (noobase.image.ReprojectResult, "error"),
...
def test_pyo3_module_metadata_uses_importable_paths():
    ...
    expected = {
        ...
        noobase.convolve.gaussian1d: "noobase._core.convolve",
        noobase.convolve.conv1d: "noobase._core.convolve",
        noobase.convolve.conv_axis: "noobase._core.convolve",
        noobase.convolve.conv2d: "noobase._core.convolve",
        noobase.convolve.conv2d_renorm: "noobase._core.convolve",
        noobase.convolve.conv_axis_renorm: "noobase._core.convolve",
        noobase.spectroscopy.synthetic_photometry.synthetic: "noobase._core.spectroscopy.synthetic_photometry",
